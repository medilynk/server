...
export const createAppointment=async(req,res)=>{
    try{
        ...
        res.status(200).json({message:"succesfully created appointment", data:created_appointment})
...
export const update_appointment = async(req,res)=>{
    try{
        ...
        res.status(200).json({message:"successfully updated appointment", data:update_appointment})
...
export const read_appointment_all = async(req, res)=>{
    try{
        ...
        res.status(200).json({message:"successfully fetched all appointments"})
...
export const read_appointment_unique = async(req, res)=>{
    try{
        ...
        res.status(200).json({message:"successfully fetched unique appointments"})
